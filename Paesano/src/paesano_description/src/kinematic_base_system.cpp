...
public:
                 ...
                 EventManager & /*_eventMgr*/) override
  {
    ...
    node_ = std::make_shared<rclcpp::Node>("paesano_kinematic_base");
...
GZ_ADD_PLUGIN(
  paesano::KinematicBaseSystem,
  gz::sim::System,
  gz::sim::ISystemConfigure,
  gz::sim::ISystemPreUpdate)

GZ_ADD_PLUGIN_ALIAS(paesano::KinematicBaseSystem, "paesano::KinematicBaseSystem")
GZ_ADD_PLUGIN_ALIAS(paesano::KinematicBaseSystem, "paesano_kinematic_base")
