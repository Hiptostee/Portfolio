#ifndef PAESANO_NAVIGATION__A_STAR_ACTION_SERVER_HPP_
...
{
public:
  using AStarAction = paesano_navigation::action::AStar;
...
#endif  // PAESANO_NAVIGATION__A_STAR_ACTION_SERVER_HPP_
