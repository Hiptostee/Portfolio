    ...
    <div className="bg-white h-screen ">
      ...
      <header className="absolute inset-x-0 top-0 z-50">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <Link
                key={item.name}
                href={item.href}
                className="text-sm font-semibold leading-6 text-gray-50 hover:bg-green-900 rounded-lg px-3 py-2"
              >
                {item.name}
              </Link>
            ))}
        ...
        >
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full h-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                ...
                <div className="space-y-2 py-6">
                  {navigation.map((item) => (
                    <Link
                      key={item.name}
                      href={item.href}
                      className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-50 hover:bg-green-900"
                    >
                      {item.name}
                    </Link>
                  ))}
