...
- **Devpost:** https://devpost.com/software/swishhh
- **Archived Demo (NOT ACTIVELY MAINTAINED):** https://aiatl.vercel.app
...
- live NBA scoreboard and play-by-play data
- webcam gesture detection
- real-time updates
- prediction overlays and scoring

## Team

This was a four-person group project:

- **Kevin Gao** (`@Pudging`)
- **Nash Pillai** (`@nash-pillai`)
- **Neha Nataraj** (`@nehanataraj`)
- **Joe Marra** (`@Hiptostee`)
